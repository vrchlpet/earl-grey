...
public class ElementImpl extends MinimalEObjectImpl.Container implements Element
{
  ...
  {
    return StatemodelPackage.Literals.ELEMENT;
  }
  ...
  public EList<Annotation> getAnnotation()
  {
    if (annotation == null)
    {
      annotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, StatemodelPackage.ELEMENT__ANNOTATION);
    }
    return annotation;
  }
