		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCallMessageAccess().getGroup_4_1(), "rule__CallMessage__Group_4_1__0");
					put(grammarAccess.getCallMessageAccess().getGroup_4_1_1(), "rule__CallMessage__Group_4_1_1__0");
					...
					put(grammarAccess.getNewMessageAccess().getGroup_3_1(), "rule__NewMessage__Group_3_1__0");
					put(grammarAccess.getNewMessageAccess().getGroup_3_1_1(), "rule__NewMessage__Group_3_1_1__0");
					...
					put(grammarAccess.getCallMessageAccess().getParameterAssignment_4_1_0(), "rule__CallMessage__ParameterAssignment_4_1_0");
					put(grammarAccess.getCallMessageAccess().getParameterAssignment_4_1_1_1(), "rule__CallMessage__ParameterAssignment_4_1_1_1");
					put(grammarAccess.getCallMessageAccess().getReturnAssignment_5(), "rule__CallMessage__ReturnAssignment_5");
					put(grammarAccess.getNewMessageAccess().getSourceParticipantAssignment_0(), "rule__NewMessage__SourceParticipantAssignment_0");
					put(grammarAccess.getNewMessageAccess().getTargetParticipantAssignment_2(), "rule__NewMessage__TargetParticipantAssignment_2");
					put(grammarAccess.getNewMessageAccess().getParameterAssignment_3_1_0(), "rule__NewMessage__ParameterAssignment_3_1_0");
					put(grammarAccess.getNewMessageAccess().getParameterAssignment_3_1_1_1(), "rule__NewMessage__ParameterAssignment_3_1_1_1");
					...
					put(grammarAccess.getDeleteMessageAccess().getSourceParticipantAssignment_0(), "rule__DeleteMessage__SourceParticipantAssignment_0");
