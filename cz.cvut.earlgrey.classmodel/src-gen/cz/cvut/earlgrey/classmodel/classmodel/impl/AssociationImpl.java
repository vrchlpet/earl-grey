 ...
 * <ul>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#isHeadNavigable <em>Head Navigable</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#getHeadVisibility <em>Head Visibility</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#getHeadLabel <em>Head Label</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#getHeadMultiplicity <em>Head Multiplicity</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#isTailNavigable <em>Tail Navigable</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#getTailVisibility <em>Tail Visibility</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#getTailLabel <em>Tail Label</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.AssociationImpl#getTailMultiplicity <em>Tail Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssociationImpl extends RelationshipImpl implements Association
{
  ...
  {
    return ClassmodelPackage.Literals.ASSOCIATION;
  }
  ...
  public void setHeadNavigable(boolean newHeadNavigable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__HEAD_NAVIGABLE, oldHeadNavigable, headNavigable));
  }
  ...
  public void setHeadVisibility(Visibility newHeadVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__HEAD_VISIBILITY, oldHeadVisibility, headVisibility));
  }
  ...
  public void setHeadLabel(String newHeadLabel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__HEAD_LABEL, oldHeadLabel, headLabel));
  }
  ...
  public NotificationChain basicSetHeadMultiplicity(Multiplicity newHeadMultiplicity, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__HEAD_MULTIPLICITY, oldHeadMultiplicity, newHeadMultiplicity);
  ...
  public void setHeadMultiplicity(Multiplicity newHeadMultiplicity)
  {
    if (newHeadMultiplicity != headMultiplicity)
    {
      ...
      if (headMultiplicity != null)
        msgs = ((InternalEObject)headMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.ASSOCIATION__HEAD_MULTIPLICITY, null, msgs);
      if (newHeadMultiplicity != null)
        msgs = ((InternalEObject)newHeadMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.ASSOCIATION__HEAD_MULTIPLICITY, null, msgs);
      msgs = basicSetHeadMultiplicity(newHeadMultiplicity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__HEAD_MULTIPLICITY, newHeadMultiplicity, newHeadMultiplicity));
  }
  ...
  public void setTailNavigable(boolean newTailNavigable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__TAIL_NAVIGABLE, oldTailNavigable, tailNavigable));
  }
  ...
  public void setTailVisibility(Visibility newTailVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__TAIL_VISIBILITY, oldTailVisibility, tailVisibility));
  }
  ...
  public void setTailLabel(String newTailLabel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__TAIL_LABEL, oldTailLabel, tailLabel));
  }
  ...
  public NotificationChain basicSetTailMultiplicity(Multiplicity newTailMultiplicity, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__TAIL_MULTIPLICITY, oldTailMultiplicity, newTailMultiplicity);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTailMultiplicity(Multiplicity newTailMultiplicity)
  {
    if (newTailMultiplicity != tailMultiplicity)
    {
      ...
      if (tailMultiplicity != null)
        msgs = ((InternalEObject)tailMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.ASSOCIATION__TAIL_MULTIPLICITY, null, msgs);
      if (newTailMultiplicity != null)
        msgs = ((InternalEObject)newTailMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.ASSOCIATION__TAIL_MULTIPLICITY, null, msgs);
      msgs = basicSetTailMultiplicity(newTailMultiplicity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.ASSOCIATION__TAIL_MULTIPLICITY, newTailMultiplicity, newTailMultiplicity));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ClassmodelPackage.ASSOCIATION__HEAD_MULTIPLICITY:
        return basicSetHeadMultiplicity(null, msgs);
      case ClassmodelPackage.ASSOCIATION__TAIL_MULTIPLICITY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ClassmodelPackage.ASSOCIATION__HEAD_NAVIGABLE:
        return isHeadNavigable();
      case ClassmodelPackage.ASSOCIATION__HEAD_VISIBILITY:
        return getHeadVisibility();
      case ClassmodelPackage.ASSOCIATION__HEAD_LABEL:
        return getHeadLabel();
      case ClassmodelPackage.ASSOCIATION__HEAD_MULTIPLICITY:
        return getHeadMultiplicity();
      case ClassmodelPackage.ASSOCIATION__TAIL_NAVIGABLE:
        return isTailNavigable();
      case ClassmodelPackage.ASSOCIATION__TAIL_VISIBILITY:
        return getTailVisibility();
      case ClassmodelPackage.ASSOCIATION__TAIL_LABEL:
        return getTailLabel();
      case ClassmodelPackage.ASSOCIATION__TAIL_MULTIPLICITY:
