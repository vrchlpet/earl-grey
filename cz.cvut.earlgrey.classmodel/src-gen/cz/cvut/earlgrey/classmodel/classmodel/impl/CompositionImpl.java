 ...
 * <ul>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#isHeadNavigable <em>Head Navigable</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#getHeadVisibility <em>Head Visibility</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#getHeadLabel <em>Head Label</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#getHeadMultiplicity <em>Head Multiplicity</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#isTailNavigable <em>Tail Navigable</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#getTailVisibility <em>Tail Visibility</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#getTailLabel <em>Tail Label</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.CompositionImpl#getTailMultiplicity <em>Tail Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositionImpl extends RelationshipImpl implements Composition
{
  ...
  {
    return ClassmodelPackage.Literals.COMPOSITION;
  }
  ...
  public void setHeadNavigable(boolean newHeadNavigable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__HEAD_NAVIGABLE, oldHeadNavigable, headNavigable));
  }
  ...
  public void setHeadVisibility(Visibility newHeadVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__HEAD_VISIBILITY, oldHeadVisibility, headVisibility));
  }
  ...
  public void setHeadLabel(String newHeadLabel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__HEAD_LABEL, oldHeadLabel, headLabel));
  }
  ...
  public NotificationChain basicSetHeadMultiplicity(Multiplicity newHeadMultiplicity, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__HEAD_MULTIPLICITY, oldHeadMultiplicity, newHeadMultiplicity);
  ...
  public void setHeadMultiplicity(Multiplicity newHeadMultiplicity)
  {
    if (newHeadMultiplicity != headMultiplicity)
    {
      ...
      if (headMultiplicity != null)
        msgs = ((InternalEObject)headMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.COMPOSITION__HEAD_MULTIPLICITY, null, msgs);
      if (newHeadMultiplicity != null)
        msgs = ((InternalEObject)newHeadMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.COMPOSITION__HEAD_MULTIPLICITY, null, msgs);
      msgs = basicSetHeadMultiplicity(newHeadMultiplicity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__HEAD_MULTIPLICITY, newHeadMultiplicity, newHeadMultiplicity));
  }
  ...
  public void setTailNavigable(boolean newTailNavigable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__TAIL_NAVIGABLE, oldTailNavigable, tailNavigable));
  }
  ...
  public void setTailVisibility(Visibility newTailVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__TAIL_VISIBILITY, oldTailVisibility, tailVisibility));
  }
  ...
  public void setTailLabel(String newTailLabel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__TAIL_LABEL, oldTailLabel, tailLabel));
  }
  ...
  public NotificationChain basicSetTailMultiplicity(Multiplicity newTailMultiplicity, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__TAIL_MULTIPLICITY, oldTailMultiplicity, newTailMultiplicity);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTailMultiplicity(Multiplicity newTailMultiplicity)
  {
    if (newTailMultiplicity != tailMultiplicity)
    {
      ...
      if (tailMultiplicity != null)
        msgs = ((InternalEObject)tailMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.COMPOSITION__TAIL_MULTIPLICITY, null, msgs);
      if (newTailMultiplicity != null)
        msgs = ((InternalEObject)newTailMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClassmodelPackage.COMPOSITION__TAIL_MULTIPLICITY, null, msgs);
      msgs = basicSetTailMultiplicity(newTailMultiplicity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClassmodelPackage.COMPOSITION__TAIL_MULTIPLICITY, newTailMultiplicity, newTailMultiplicity));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ClassmodelPackage.COMPOSITION__HEAD_MULTIPLICITY:
        return basicSetHeadMultiplicity(null, msgs);
      case ClassmodelPackage.COMPOSITION__TAIL_MULTIPLICITY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ClassmodelPackage.COMPOSITION__HEAD_NAVIGABLE:
        return isHeadNavigable();
      case ClassmodelPackage.COMPOSITION__HEAD_VISIBILITY:
        return getHeadVisibility();
      case ClassmodelPackage.COMPOSITION__HEAD_LABEL:
        return getHeadLabel();
      case ClassmodelPackage.COMPOSITION__HEAD_MULTIPLICITY:
        return getHeadMultiplicity();
      case ClassmodelPackage.COMPOSITION__TAIL_NAVIGABLE:
        return isTailNavigable();
      case ClassmodelPackage.COMPOSITION__TAIL_VISIBILITY:
        return getTailVisibility();
      case ClassmodelPackage.COMPOSITION__TAIL_LABEL:
        return getTailLabel();
      case ClassmodelPackage.COMPOSITION__TAIL_MULTIPLICITY:
