 ...
 *   <li>{@link cz.cvut.earlgrey.classmodel.classmodel.impl.PackageImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageImpl extends AbstractElementImpl implements cz.cvut.earlgrey.classmodel.classmodel.Package
{
  /**
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, ClassmodelPackage.PACKAGE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ClassmodelPackage.PACKAGE__ELEMENTS:
