 ...
 * <!-- end-user-doc -->
 * @see cz.cvut.earlgrey.classmodel.classmodel.ClassmodelPackage#getVisibility()
 * @model
 * @generated
 */
public enum Visibility implements Enumerator
{
   ...
   * @ordered
   */
  PACKAGE_PRIVATE(3, "PACKAGE_PRIVATE", "~");
   ...
   * @ordered
   */
  public static final int PACKAGE_PRIVATE_VALUE = 3;
