...
public class ClassmodelJavaValidator extends AbstractClassmodelJavaValidator {
	 ...
	 */
	// @Check
	// public void checkCardinality(Relationship relation) {
	// if (!validateCardinality(relation.getHeadMultiplicity())) {
	...
	// }
	// if (!validateCardinality(relation.getTailMultiplicity())) {
	// warning(MSG_CARDINALITY_SIMPLIFIED,
	...
	// */
	// private boolean validateCardinality(Multiplicity from) {
	// boolean output = true;
	// String value = null;
