...
public class AbstractSequencemodelSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_TransitionBlock___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_TransitionBlock___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getTransitionBlockAccess().getLeftParenthesisKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getTransitionBlockAccess().getRightParenthesisKeyword_2_2()));
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_CallMessage___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q.equals(syntax))
				...
				emit_NewMessage___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_TransitionBlock___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q.equals(syntax))
				emit_TransitionBlock___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('(' ')')?
	 */
	protected void emit_NewMessage___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     ('(' ')')?
	 */
	protected void emit_TransitionBlock___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
