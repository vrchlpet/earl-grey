 ...
 *   <li>{@link cz.cvut.earlgrey.sequencemodel.sequencemodel.impl.ReturnMessageImpl#getParam <em>Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReturnMessageImpl extends MessageImpl implements ReturnMessage
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SequencemodelPackage.RETURN_MESSAGE__NAME, oldName, name));
  }
  ...
  public EList<String> getParam()
  {
    if (param == null)
    {
      param = new EDataTypeEList<String>(String.class, this, SequencemodelPackage.RETURN_MESSAGE__PARAM);
    }
    return param;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SequencemodelPackage.RETURN_MESSAGE__NAME:
        return getName();
      case SequencemodelPackage.RETURN_MESSAGE__PARAM:
        return getParam();
    }
