 ...
 *   <li>{@link cz.cvut.earlgrey.sequencemodel.sequencemodel.impl.MessageImpl#getParam <em>Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends MinimalEObjectImpl.Container implements Message
{
  ...
  public EList<String> getParam()
  {
    if (param == null)
    {
      param = new EDataTypeEList<String>(String.class, this, SequencemodelPackage.MESSAGE__PARAM);
    }
    return param;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SequencemodelPackage.MESSAGE__NAME:
        return getName();
      case SequencemodelPackage.MESSAGE__PARAM:
        return getParam();
    }
