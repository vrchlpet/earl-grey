 ...
 * <ul>
 *   <li>{@link cz.cvut.earlgrey.sequencemodel.sequencemodel.impl.ReturnImpl#getName <em>Name</em>}</li>
 *   <li>{@link cz.cvut.earlgrey.sequencemodel.sequencemodel.impl.ReturnImpl#getArray <em>Array</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReturnImpl extends MinimalEObjectImpl.Container implements Return
{
  ...
  {
    return SequencemodelPackage.Literals.RETURN;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SequencemodelPackage.RETURN__NAME, oldName, name));
  }
  ...
  public EList<Array> getArray()
  {
    if (array == null)
    {
      array = new EObjectContainmentEList<Array>(Array.class, this, SequencemodelPackage.RETURN__ARRAY);
    }
    return array;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SequencemodelPackage.RETURN__ARRAY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SequencemodelPackage.RETURN__NAME:
        return getName();
      case SequencemodelPackage.RETURN__ARRAY:
        return getArray();
    }
